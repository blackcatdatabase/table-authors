...
<div style='font-size:13px;opacity:0.92;'>Lineage heat: 1 outbound / 1 inbound · ✅ No engine drift detected · Index coverage: ready · PII: 1 · Changelog: fresh (2 d)</div>
</div>
...
- Pkg folder: [packages\authors](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\authors)
...
graph LR
  ...
  authors["authors"]:::center
  authors -->|FK| tenants["tenants"]:::link
  books["books"]:::inbound -->|FK| authors
...
| [040_views_modules.mysql.sql](schema/modules/blackcat-catalog/040_views_modules.mysql.sql) | mysql |
| [040_views_modules.postgres.sql](schema/modules/blackcat-catalog/040_views_modules.postgres.sql) | postgres |
...
| [040_views_modules.mysql.sql](schema/modules/blackcat-catalog/040_views_modules.mysql.sql) | mysql | package |
| [040_views_modules.postgres.sql](schema/modules/blackcat-catalog/040_views_modules.postgres.sql) | postgres | package |
...
## Usage
- Install/upgrade schema: pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package authors -Apply
