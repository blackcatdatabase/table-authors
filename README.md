...
> Lineage: 1 outbound / 1 inbound · ✅ No engine drift detected · Index coverage: ready · PII flags: 1 · Changelog: fresh (2 d)
...
pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package authors -Apply
