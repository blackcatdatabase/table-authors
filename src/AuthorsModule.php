...
final class AuthorsModule implements ModuleInterface {
    ...
    public function name(): string { return 'table-authors'; }
    public function table(): string { return 'authors'; }
    ...
    public function status(Database $db, SqlDialect $d): array {
        ...
        $indexes = [ 'idx_authors_avg_rating', 'idx_authors_books_count' ];
        $fks     = [];
        $missingIdx = [];
        $missingFk  = [];
