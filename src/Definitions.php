...
final class Definitions {
    ...
    /** @return string[] */
    public static function columns(): array { return [ 'id', 'name', 'slug', 'bio', 'photo_url', 'story', 'books_count', 'ratings_count', 'rating_sum', 'avg_rating', 'last_rating_at', 'created_at', 'updated_at', 'version', 'deleted_at' ]; }
    ...
    public static function uniqueKeys(): array { return [ [ 'slug' ], [ 'id' ] ]; }
    ...
    public static function intColumns(): array { return [ 'id', 'books_count', 'ratings_count', 'rating_sum', 'version' ]; }
