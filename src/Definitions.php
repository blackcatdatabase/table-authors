...
final class Definitions {
    ...
    public static function uniqueKeys(): array { return [ [ 'tenant_id', 'slug_ci' ], [ 'tenant_id', 'id' ], [ 'id' ] ]; }
    ...
    public static function intColumns(): array { return [ 'id', 'tenant_id', 'books_count', 'ratings_count', 'rating_sum', 'version' ]; }
