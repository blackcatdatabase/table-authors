...
final class AuthorRepository implements RepoContract {
    ...
    public function insert(array $row): void {
        ...
        $tblEsc  = $isMysql ? '`authors`' : '"authors"';
     ...
     * [ 'slug' ] = unikátní klíče (sloupce) pro konflikty,
     * [ 'name', 'bio', 'photo_url', 'story', 'books_count', 'ratings_count', 'rating_sum', 'avg_rating', 'last_rating_at', 'updated_at', 'deleted_at' ] = které sloupce aktualizovat.
     */
    public function upsert(array $row): void {
        ...
        $keys = [ 'slug' ];
        $upd  = [ 'name', 'bio', 'photo_url', 'story', 'books_count', 'ratings_count', 'rating_sum', 'avg_rating', 'last_rating_at', 'updated_at', 'deleted_at' ];
