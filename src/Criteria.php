 ...
 * - whitelist filtrů: [ 'id', 'name', 'slug', 'bio', 'photo_url', 'story', 'books_count', 'ratings_count', 'rating_sum', 'avg_rating', 'last_rating_at', 'created_at', 'updated_at', 'version', 'deleted_at' ]
 * - whitelist LIKE:   [ 'name', 'slug', 'bio', 'photo_url', 'story' ]
 * Podporované tvary:
...
final class Criteria {
    ...
    public function toSql(bool $viewMode = false): array {
        ...
        $allowed = array_fill_keys([ 'id', 'name', 'slug', 'bio', 'photo_url', 'story', 'books_count', 'ratings_count', 'rating_sum', 'avg_rating', 'last_rating_at', 'created_at', 'updated_at', 'version', 'deleted_at' ], true);
        ...
        if ($this->search !== null) {
            $searchCols = [ 'name', 'slug', 'bio', 'photo_url', 'story' ];
            $likeParts = []; $i=0;
        ...
        $order = null;
        if ($this->sort) {
            $safeCols = array_fill_keys([ 'id', 'name', 'slug', 'bio', 'photo_url', 'story', 'books_count', 'ratings_count', 'rating_sum', 'avg_rating', 'last_rating_at', 'created_at', 'updated_at', 'version', 'deleted_at' ], true);
            $parts = [];
