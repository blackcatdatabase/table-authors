...
final class Criteria extends BaseCriteria
{
    ...
    {
        return [ 'id', 'tenant_id', 'name', 'slug', 'slug_ci', 'bio', 'photo_url', 'story', 'books_count', 'ratings_count', 'rating_sum', 'avg_rating', 'last_rating_at', 'created_at', 'updated_at', 'version', 'deleted_at', 'is_live' ];
    }

    /** Columns used for full-text LIKE/ILIKE searches. */
    protected function searchable(): array
    {
        return [ 'name', 'slug', 'slug_ci', 'bio', 'photo_url', 'story' ];
    }

    /** Columns allowed in ORDER BY (falls back to filterable() when empty). */
    protected function sortable(): array
    {
        $x = [ 'id', 'tenant_id', 'name', 'slug', 'slug_ci', 'bio', 'photo_url', 'story', 'books_count', 'ratings_count', 'rating_sum', 'avg_rating', 'last_rating_at', 'created_at', 'updated_at', 'version', 'deleted_at', 'is_live' ];
    ...
    public static function fromDb(
        ...
        if (\method_exists(\BlackCat\Database\Packages\Authors\Definitions::class, 'softDeleteColumn')) {
            $soft = \BlackCat\Database\Packages\Authors\Definitions::softDeleteColumn();
